...
- (void)viewDidLoad {
    ...
    self.scrolViewDrivingLicence.contentSize = CGSizeMake(self.scrolViewDrivingLicence.frame.size.width, self.onView.frame.size.height * 10.5 + 50);
...
{
    self.scrolViewDrivingLicence.contentSize = CGSizeMake(self.scrolViewDrivingLicence.frame.size.width, self.onView.frame.size.height * 14.5 + 50);
}
